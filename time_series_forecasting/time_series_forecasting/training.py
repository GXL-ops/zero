...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_csv_path", default=r"../data/processed_data.csv")
    parser.add_argument("--feature_target_names_path", default=r"../data/config.json")
    parser.add_argument("--output_json_path", default=r"models/trained_config.json")
    parser.add_argument("--log_dir", default=r"models/ts_views_logs")
    parser.add_argument("--model_dir", default=r"models/ts_views_models")
