...
if __name__ == "__main__":
    ...
    parser.add_argument("--trained_json_path", default=r"../data/trained_config.json")
    parser.add_argument("--eval_json_path", default=r"../data/eval.json")
    parser.add_argument("--data_for_visualization_path", default=r"../data/visualization.json")
